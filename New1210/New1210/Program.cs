        ...
        private static void Main(string[] args)
        {
            ...
            try
            {
                do
                {
                    ...
                    Console.WriteLine("7 for Cars"); //automated teller machine
                    Console.WriteLine("8 for ITSchool"); //ITSchool
                    ...
                    {
                        Console.WriteLine();
                        Console.WriteLine("ITSchool");
                        Console.WriteLine();
                        ITSchool C = new ITSchool();
                        C.MainRun();
                    }
